...
void AnalyzerCore::FillDileptonPlots(std::vector<Lepton*> leps, TString this_region, double weight) {
  ...
  JSFillHist(this_region, "Dilepton_LowMass___"+this_region, (Leading_Lepton + Sub_Lepton).M(), weight, 2000,0.,20.);
  JSFillHist(this_region, "Dilepton_DeltaR___"+this_region, Leading_Lepton.DeltaR( Sub_Lepton ), weight, 50000,0.,5.0);
